...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/Immutable/Immutable.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/RxFSPagerView/RxFSPagerView.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/RxGesture/RxGesture.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/RxIGListKit/RxIGListKit.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/VVAdapter/VVAdapter.framework"
