...
//  GreatApp
//
//  Created by chinaxxren 2019/4/6.
...
public extension UITextField {
    ...
    @IBInspectable var placeholderColor: UIColor? {
        ...
        set {
            guard let color = newValue, let placeholder = placeholder, !placeholder.isEmpty else {
                return
            }
    ...
    @IBInspectable var placeholderFont: UIFont? {
        ...
        set {
            guard let font = newValue, let placeholder = placeholder, !placeholder.isEmpty else {
                return
            }
            if let attributedPlaceholder = attributedPlaceholder {
                let attr = NSMutableAttributedString(attributedString: attributedPlaceholder)
    ...
    var isValidEmail: Bool {
        guard let text = trimmedText else {
            return false
        }
